...
export function AssetShelf(): JSX.Element | null {
  ...
  // Chain-agnostic on purpose: stocks aren't listed on every chain, so applying the Explore network
  // filter empties the shelf and leaves a gap on chains without stocks (e.g. Monad).
