...
// Matches IV4Quoter's generated ABI (v4-periphery src/lens/V4Quoter.sol). Regenerate from the
// published v4-periphery artifacts when the quoter's interface moves.
