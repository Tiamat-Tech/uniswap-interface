/**
 * Minimal deterministic CSS parser: flattens CSS text into selector →
 * declaration rules. Anything unrecognized throws instead of being silently
 * coerced, so a caller can never read a result built on unparsed data.
 */
