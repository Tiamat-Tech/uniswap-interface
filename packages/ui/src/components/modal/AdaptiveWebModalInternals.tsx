/**
 * Platform-split base stub for the AdaptiveWebModal cluster's web-only support machinery.
 ...
 * this file at runtime — every entry point throws to make an accidental off-web import loud.
 */
