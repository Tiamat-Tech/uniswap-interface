/**
 * Special-case token colors for `useExtractedTokenColor`, copied from
 * ui/src/utils/colors. The extracted-token-color parity suite pins the table
 * against the live ui source so it cannot drift.
 */
...
export function getSpecialCaseTokenColor(imageUrl: string | null | undefined, isDarkMode: boolean): string | null {
