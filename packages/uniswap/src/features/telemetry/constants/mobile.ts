...
export enum MobileEventName {
  ...
  ExploreCategoryPillSelected = 'Explore Category Pill Selected',
  ExploreCollectionsViewAllSelected = 'Explore Collections View All Selected',
  ...
  ExploreTrendingHeaderSelected = 'Explore Trending Header Selected',
