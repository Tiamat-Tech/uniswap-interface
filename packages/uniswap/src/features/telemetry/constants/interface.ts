export enum InterfaceEventName {
  ...
  AuctionHoverCardDataLoaded = 'Auction Hover Card Data Loaded',
  AuctionHoverCardOpened = 'Auction Hover Card Opened',
  ...
  MarginPaymentTokenSelected = 'Margin Payment Token Selected',
  MarginPlanCreated = 'Margin Plan Created',
  MarginPlanStepCompleted = 'Margin Plan Step Completed',
  MarginPlanStepFailed = 'Margin Plan Step Failed',
  MarginPositionActionSelected = 'Margin Position Action Selected',
  MarginPositionClosed = 'Margin Position Closed',
  MarginTerminalEntered = 'Margin Terminal Entered',
  MarginVenuePreferenceToggled = 'Margin Venue Preference Toggled',
  MarginVenueRouted = 'Margin Venue Routed',
