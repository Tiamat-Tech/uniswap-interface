export const ModalName = {
  ...
  LaunchMethodExplainer: 'launch-method-explainer-modal',
  LaunchTokenSelection: 'launch-token-selection-modal',
  Legal: 'legal',
  ...
  MarginAdd: 'margin-add-modal',
  MarginAdjustPosition: 'margin-adjust-position-modal',
  MarginChangeLeverage: 'margin-change-leverage-modal',
  MarginChartGlossary: 'margin-chart-glossary-modal',
  MarginClose: 'margin-close-modal',
  MarginMarketSelector: 'margin-market-selector-modal',
  MarginOpenReview: 'margin-open-review-modal',
  MarginPaymentTokenSelector: 'margin-payment-token-selector-modal',
  MarginPlanReview: 'margin-plan-review-modal',
  MarginVenuePreferences: 'margin-venue-preferences-modal',
  MarginWithdraw: 'margin-withdraw-modal',
  MigrateLiquidity: 'migrate-liquidity',
  MigrateRefundInfo: 'migrate-refund-info-modal',
  ...
  QrCodeSelectionWarning: 'qr-code-selection-warning-modal',
  ...
  PoolsFilter: 'pools-filter-modal',
